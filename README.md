...
[Email](mailto:hajarelhilali57@gmail.com) · [LinkedIn](https://www.linkedin.com/in/hajar-elhilali)

Computer engineering student specializing in **backend development with Java and the Spring ecosystem**. I build server-side applications with a focus on clean architecture, REST APIs, and scalable, maintainable systems, with additional experience in frontend development.

- Backend: Spring Boot, Spring Security, Spring Data JPA, REST APIs
- Open to backend / software engineering internships and collaboration
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://pixelstack-three.vercel.app/api/stats?user=Hajar-ELHILALI&theme=midnight">
  <img src="https://pixelstack-three.vercel.app/api/stats?user=Hajar-ELHILALI&theme=light" alt="GitHub stats">
</picture>
